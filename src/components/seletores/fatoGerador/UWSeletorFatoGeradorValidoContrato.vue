...
const getLista = async () => {
    try {
        await montarFiltros();
        const data = await Service.getSeletorByValidadoParaContratoAgricola(lazyParams.value, props.itemId || -1, props.grupoOperacaoAgricolaId || -1, props.operacaoInternaId || -1);
