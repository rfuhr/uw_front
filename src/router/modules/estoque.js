...
const estoqueRouter = {
    ...
    children: [
        ...
        {
            path: 'configuracoes',
            name: 'estoque-configuracoes',
            meta: {
                breadcrumb: [{ parent: 'Estoque', label: 'Configurações' }]
            },
            children: [
                {
                    path: 'validacao-departamento-grupo-contabil',
                    component: () => import('../../views/estoque/configuracoes/validaDepartamentoGrupoContabil/ValidaDepartamentoGrupoContabil.vue'),
                    name: 'estoque-configuracoes-validacao-departamento-grupo-contabil',
                    meta: {
                        breadcrumb: [{ label: 'Estoque' }, { label: 'Configurações' }, { label: 'Validação Departamento x Grupo Contábil' }],
                        tag: 'validadepartamentogrupocontabil',
                        operacao: 'consultar'
                    }
                }
            ]
