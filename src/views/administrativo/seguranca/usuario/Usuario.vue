...
<template>
    <UWPageCrud ref="crudlista" tag="usuario" title="Usuários" :columns="columns" :service="UsuarioService" @openNew="openNew" @openEdit="openEdit($event)" @openDelete="openDelete" sortField="nome"/>
</template>
