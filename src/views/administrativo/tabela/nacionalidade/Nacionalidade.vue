...
<template>
    <UWPageCrud ref="crudlista" tag="nacionalidade" title="Nacionalidade" :columns="columns" :service="Service" @openNew="openNew" @openEdit="openEdit" @openDelete="openDelete" />
