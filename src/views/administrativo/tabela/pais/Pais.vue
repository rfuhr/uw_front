...
<template>
    <UWPageCrud ref="crudlistapais" tag="pais" title="Países" :columns="columns" :service="Service" @openNew="openNew" @openEdit="openEdit" @openDelete="openDelete" sortField="nome"/>
