...
import { ValidaPrecoAgricolaItemService as Service, ItemService, TipoPrecoAgricolaService, PredefinicaoPrecoAgricolaService } from '@/service';
...
<template>
    <Dialog v-model:visible="showDialogComputed" :style="{ width: '40%' }" :header="mode === 'create' ? 'Nova Validação' : 'Alterar Validação'" :modal="true" :closable="false" @show="showModal">
        <UWForm :schema="schema" :values="formData" ref="formValidacaoPrecoAgricolaProduto" @doCancel="hideDialog" @doSubmit="salvarRegistro">
