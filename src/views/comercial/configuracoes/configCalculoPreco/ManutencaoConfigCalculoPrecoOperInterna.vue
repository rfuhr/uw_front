...
<template>
    ...
    <div class="col-12">
        ...
        <DataTable 
            ...
            <Column field="operacaoEstoqueName" header="Operação do Estoque" style="width: 10%"> </Column>
            ...
            <template #errors="{ errors }">
                <div class="col-12">
                    <div class="p-fluid formgrid grid">
                        ...
                        <UWPickList id="operacaoEstoque" label="Operação de Estoque" v-model="formData.operacaoEstoque" optionLabel="name" optionValue="value" required :options="tiposOperacoes" @changeObject="changeOperacaoEstoque" classContainer="col-12 md:col-4" />
