...
import { PlanoClassificacaoItemService as Service } from '@/service';
...
<template>
    <UWPageCrud ref="crudlista" tag="planoclassificacaoitem" title="Classificação Comercial" labelButtonNew="Nova Conta" iconButtonNew="pi pi-tags" :columns="columns" :service="Service" @openNew="openNew" @openEdit="openEdit" @openDelete="openDelete" sortField="nome">
