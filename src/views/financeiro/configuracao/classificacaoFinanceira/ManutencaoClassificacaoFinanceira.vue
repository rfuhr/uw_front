...
const showModal = async () => {
    ...
    if (props.mode === 'novaConta') {
        ...
        await PlanoClassificacaoFinanceiraService.getById(props.idRegistroSuperior).then((data) => {
        ...
        await PlanoClassificacaoFinanceiraService.getById(props.idRegistro).then((data) => {
...
const criarRegistro = () => {
    PlanoClassificacaoFinanceiraService.create(formData.value)
        .then(() => {
...
const alterarRegistro = () => {
    ...
    PlanoClassificacaoFinanceiraService.update(formData.value)
        .then(() => {
