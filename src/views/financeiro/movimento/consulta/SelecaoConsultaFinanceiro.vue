...
const selecionarRegistros = async () => {
    ...
    const consultaRequest = {...formData.value};
    await TituloService.selecaoConsulta(consultaRequest)
        .then((response) => {
...
<template>
    <UWPageBase title="Consulta de Títulos" subtitle="Informe os filtros para seleção de títulos para consulta">
