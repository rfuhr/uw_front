...
const localModelValue = computed({
    get: () => props.modelValue || {configuracaoFiscalCofins: {
...
<template>
    <UWFieldSet title="Configuração Fiscal do COFINS" class="col-12">
        <div class="p-fluid formgrid grid">
            <UWSeletor 
                        ...
                        :columnsFilters="[{ field: 'tipoTributo', value: 'COFINS', matchMode: 'equal', tipoField: 'text', fieldFilter: 'tipoTributo' }]"
                        >
