                        ...
                        <div class="col-12">
                            <div class="p-fluid formgrid grid">
                                ...
                                <template v-if="grupoTributadoQtde()">
                                    ...
                                    <UWDecimal id="vAliqCofins" label="Alíquota do Cofins (Reais)" disabled v-model="itemModelValue.cofins.configuracaoFiscalCofins.aliquota" classContainer="col-12 md:col-2" />
                                    <UWCurrency id="valorCofins" label="Valor do Cofins" disabled v-model="itemModelValue.cofins.valorCofins" classContainer="col-12 md:col-2" />
                                </template>
                                <template v-if="grupoOutrasOperacoes()">
                                    ...
                                    <UWDecimal v-if="itemModelValue.cofins.configuracaoFiscalCofins.tipoCalculo === 'V'" id="vAliqCofins" label="Alíquota do Cofins (Reais)" disabled v-model="itemModelValue.cofins.configuracaoFiscalCofins.aliquota" classContainer="col-12 md:col-2" />
                                ...
                                <template v-if="grupoCofinsSt()">
                                    ...
                                    <UWDecimal
                                        v-if="itemModelValue.cofins.configuracaoFiscalCofins.tipoCalculoST === 'V'"
                                        id="vAliqCofins"
                                        label="Alíquota do Cofins (Reais)"
                                        disabled
                                        v-model="itemModelValue.cofins.configuracaoFiscalCofins.aliquotaST"
                                        classContainer="col-12 md:col-2"
                                    />
