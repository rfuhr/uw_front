                    ...
                    <div class="p-fluid formgrid grid">
                        ...
                        <div class="col-12">
                            <div class="p-fluid formgrid grid">
                                ...
                                <UWCurrency id="percentualReducaoBCSt" label="Redução da Base de Cálculo (%)" disabled v-model="itemModelValue.tributacaoIcms.configuracaoFiscalIcms.reducaoBaseCalculoST" classContainer="col-12 md:col-2" />
                        ...
                        <div class="col-12">
                            <div class="p-fluid formgrid grid">
                                ...
                                <UWSeletor
                                    ...
                                    v-model="itemModelValue.tributacaoIcms.configuracaoFiscalIcms.motivoDesoneracao"
                                    disabled
                                    optionLabel="nome"
                                    optionValue="id"
